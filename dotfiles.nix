...
in
  writeShellScriptBin "dotfiles" ''
    ...
    ln -sfv "${browserpass}/lib/browserpass/hosts/chromium/com.github.browserpass.native.json" "$HOME/.config/chromium/NativeMessagingHosts/com.github.browserpass.native.json"
    symlink-git-config
  ''
