...
, dbus, xvfb_run
# add the following plus gtksourceview as nativeBuildInputs to
# resolve gobject introspection "Typelib file ... does not exist" errors
...
python3.pkgs.buildPythonApplication rec {
  ...
  nativeBuildInputs = [
    intltool itstool libxml2 gobject-introspection wrapGAppsHook pango gdk_pixbuf atk gtksourceview
  ];
  buildInputs = [
